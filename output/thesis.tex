...
\hypersetup{breaklinks=true,
            ...
            pdftitle={Evaluating Algorithms that Learn to Compose Music from Scratch},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\begin{titlepage}
    ...
    \ThisULCornerWallPaper{1.0}{style/univ_logo.eps}
        ...
        \huge
        Evaluating Algorithms that Learn to Compose Music from Scratch
...
\hypertarget{evaluating-state-of-the-art-models}{%
\chapter{Evaluating State-of-the-Art
models}\label{evaluating-state-of-the-art-models}}
